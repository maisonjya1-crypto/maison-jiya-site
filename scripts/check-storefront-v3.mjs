...
console.log("Storefront V3 (catalogue manuel + quantités avant confirmation + FR/AR/EN + référence publique propre + marques fixes + hero HD + responsive privé/public): OK");
