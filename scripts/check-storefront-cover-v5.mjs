...
if (!css.includes("storefront-reference-category-media > img")) throw new Error("Option C full-card category images missing");
if (!enhancement.includes("mj-hero-stage") || enhancement.includes("data:image/webp;base64")) throw new Error("iPhone-safe hero missing");
console.log("✓ storefront cover v5 + iPhone image checks passed");
