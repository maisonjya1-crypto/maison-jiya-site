...
import chunk6 from "./apk-chunk-6";
import chunk7 from "./apk-chunk-7";
import chunk8 from "./apk-chunk-8";

const apkBase64 = `${chunk1}${chunk2}${chunk3}${chunk4}${chunk5}${chunk6}${chunk7}${chunk8}`;
const EXPECTED_SIZE = 25279;
...
export async function GET() {
  ...
  return new Response(bytes, {
    ...
    headers: {
      ...
      "content-disposition": "attachment; filename=\"Maison-Jiya-Gestion-Android-2.5.apk\"",
